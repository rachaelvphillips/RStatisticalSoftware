...
RcppExport SEXP _hal9001fast_apply_copy_map(SEXP XSEXP, SEXP copy_mapSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const MSpMat >::type X(XSEXP);
...
RcppExport SEXP _hal9001fast_lassi_predict(SEXP XSEXP, SEXP betaSEXP, SEXP interceptSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const MSpMat >::type X(XSEXP);
...
RcppExport SEXP _hal9001fast_make_basis_list(SEXP X_subSEXP, SEXP colsSEXP, SEXP order_mapSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _hal9001fast_meets_basis(SEXP XSEXP, SEXP row_numSEXP, SEXP colsSEXP, SEXP cutoffsSEXP, SEXP ordersSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _hal9001fast_evaluate_basis(SEXP basisSEXP, SEXP XSEXP, SEXP x_basisSEXP, SEXP basis_colSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _hal9001fast_make_design_matrix(SEXP XSEXP, SEXP blistSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const NumericMatrix& >::type X(XSEXP);
...
RcppExport SEXP _hal9001fast_as_dgCMatrix(SEXP XX_SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _hal9001fast_non_zeros(SEXP XSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const MSpMat& >::type X(XSEXP);
...
RcppExport SEXP _hal9001fast_calc_pnz(SEXP XSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const MSpMat& >::type X(XSEXP);
...
RcppExport SEXP _hal9001fast_get_pnz(SEXP XSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const MSpMat& >::type X(XSEXP);
...
RcppExport SEXP _hal9001fast_calc_xscale(SEXP XSEXP, SEXP xcenterSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const MSpMat& >::type X(XSEXP);
...
RcppExport SEXP _hal9001fast_get_xscale(SEXP XSEXP, SEXP xcenterSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const MSpMat& >::type X(XSEXP);
...
RcppExport SEXP _hal9001fast_equal_double(SEXP xSEXP, SEXP ySEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_hal9001fast_make_basis_list", (DL_FUNC) &_hal9001fast_make_basis_list, 3},
    {"_hal9001fast_meets_basis", (DL_FUNC) &_hal9001fast_meets_basis, 5},
    {"_hal9001fast_evaluate_basis", (DL_FUNC) &_hal9001fast_evaluate_basis, 4},
    {"_hal9001fast_make_design_matrix", (DL_FUNC) &_hal9001fast_make_design_matrix, 2},
    {"_hal9001fast_as_dgCMatrix", (DL_FUNC) &_hal9001fast_as_dgCMatrix, 1},
    {"_hal9001fast_non_zeros", (DL_FUNC) &_hal9001fast_non_zeros, 1},
    {"_hal9001fast_calc_pnz", (DL_FUNC) &_hal9001fast_calc_pnz, 1},
    {"_hal9001fast_get_pnz", (DL_FUNC) &_hal9001fast_get_pnz, 1},
    {"_hal9001fast_calc_xscale", (DL_FUNC) &_hal9001fast_calc_xscale, 2},
    {"_hal9001fast_get_xscale", (DL_FUNC) &_hal9001fast_get_xscale, 2},
    {"_hal9001fast_equal_double", (DL_FUNC) &_hal9001fast_equal_double, 2},
    {"_rcpp_module_boot_lassi_module", (DL_FUNC) &_rcpp_module_boot_lassi_module, 0},
    {NULL, NULL, 0}
};

RcppExport void R_init_hal9001fast(DllInfo *dll) {
