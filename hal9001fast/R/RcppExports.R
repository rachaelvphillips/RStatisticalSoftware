...
calc_canon_grad <- function(X, Y, beta) {
    .Call('_hal9001fast_calc_canon_grad', PACKAGE = 'hal9001fast', X, Y, beta)
}
...
index_first_copy <- function(X) {
    .Call('_hal9001fast_index_first_copy', PACKAGE = 'hal9001fast', X)
}
...
apply_copy_map <- function(X, copy_map) {
    .Call('_hal9001fast_apply_copy_map', PACKAGE = 'hal9001fast', X, copy_map)
}

lassi_predict <- function(X, beta, intercept) {
    .Call('_hal9001fast_lassi_predict', PACKAGE = 'hal9001fast', X, beta, intercept)
}
...
make_basis_list <- function(X_sub, cols, order_map) {
    .Call('_hal9001fast_make_basis_list', PACKAGE = 'hal9001fast', X_sub, cols, order_map)
}
...
meets_basis <- function(X, row_num, cols, cutoffs, orders) {
    .Call('_hal9001fast_meets_basis', PACKAGE = 'hal9001fast', X, row_num, cols, cutoffs, orders)
}
...
evaluate_basis <- function(basis, X, x_basis, basis_col) {
    invisible(.Call('_hal9001fast_evaluate_basis', PACKAGE = 'hal9001fast', basis, X, x_basis, basis_col))
}
...
make_design_matrix <- function(X, blist) {
    .Call('_hal9001fast_make_design_matrix', PACKAGE = 'hal9001fast', X, blist)
}
...
as_dgCMatrix <- function(XX_) {
    .Call('_hal9001fast_as_dgCMatrix', PACKAGE = 'hal9001fast', XX_)
}

non_zeros <- function(X) {
    .Call('_hal9001fast_non_zeros', PACKAGE = 'hal9001fast', X)
}

calc_pnz <- function(X) {
    .Call('_hal9001fast_calc_pnz', PACKAGE = 'hal9001fast', X)
}

get_pnz <- function(X) {
    .Call('_hal9001fast_get_pnz', PACKAGE = 'hal9001fast', X)
}

calc_xscale <- function(X, xcenter) {
    .Call('_hal9001fast_calc_xscale', PACKAGE = 'hal9001fast', X, xcenter)
}

get_xscale <- function(X, xcenter) {
    .Call('_hal9001fast_get_xscale', PACKAGE = 'hal9001fast', X, xcenter)
}

equal_double <- function(x, y) {
    .Call('_hal9001fast_equal_double', PACKAGE = 'hal9001fast', x, y)
}
