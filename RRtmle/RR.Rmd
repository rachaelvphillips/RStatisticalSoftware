...
lrnr_derived <- make_learner(Lrnr_undersmooth, basis_generator = hal_basis(max_degree = 1))
...
lrnr_hal <- Lrnr_LRR_hal9001$new(method = "plugin", max_degree = 1)


sl <- make_super_learner(list(lrnr_xgboost1,lrnr_xgboost2, Lrnr_LRR_subst$new(), Lrnr_LRR_glm$new(method = "IPW"), Lrnr_LRR_glm$new(method = "plugin"),lrnr_hal
                             ), task, likelihood )
